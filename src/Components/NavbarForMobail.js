...
const BottomNavbar = () => {
     ...
     return (
          ...
          <div class="w-full ">
               ...
               <section id="bottom-navigation" class="block fixed inset-x-0 bottom-0 z-10 bg-white border-t-1 border border-secondary shadow border-x-0 border-b-0 border-opacity-30">
                    <div id="tabs" class="flex justify-between items-center pt-2">
                         <Link to="/" class="w-full focus:text-secondary hover:text-secondary justify-center inline-block text-center  ">
          ...
          <Link to="/test" class="w-full focus:text-secondary hover:text-secondary justify-center inline-block text-center ">
        <div className="mx-auto flex justify-center">
        <BsPencilSquare className='text-2xl cursor-pointer'/> 
        </div> <span class="tab tab-explore block text-xs">Test</span></Link>
          <Link to="/contact" class="w-full focus:text-secondary hover:text-secondary justify-center inline-block text-center ">
        <div className="mx-auto flex justify-center">
        <AiOutlineFileSearch className='text-2xl cursor-pointer'/> 
        </div> <span class="tab tab-explore block text-xs">Result</span></Link>
          <Link to="/contact" class="w-full focus:text-secondary hover:text-secondary justify-center inline-block text-center ">
        <div className="mx-auto flex justify-center">
        <TfiEmail className='text-2xl cursor-pointer'/> 
        </div> <span class="tab tab-explore block text-xs">Contact</span></Link>
          <Link to="/contact" class="w-full focus:text-secondary hover:text-secondary justify-center inline-block text-center ">
        <div className="mx-auto flex justify-center">
        <RxDashboard className='text-2xl cursor-pointer'/> 
        </div> <span class="tab tab-explore block text-xs">Deshboard</span></Link>
        </div>
               </section>
               </section>
          </div>
